...
export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "/work/meta-offers-expanded" },
  openGraph: pageOpenGraph(title, description, "/work/meta-offers-expanded", "article"),
};

export default function MetaOffersExpandedLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <script
