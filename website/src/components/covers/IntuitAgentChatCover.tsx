...
export function IntuitAgentChatCover({ className }: { className?: string }) {
  return (
    <svg
      ...
      viewBox="0 0 1440 964"
      preserveAspectRatio="xMidYMid meet"
      xmlns="http://www.w3.org/2000/svg"
      role="img"
      aria-label="The Intuit Agent Chat welcome screen, with a greeting, five conversation starters and the composer."
    >
      <foreignObject x="0" y="0" width="1440" height="964">
          ...
          <div className={styles.body}>
            <div className={styles.rail}>
              <div className={styles.railNav}>
                ...
                <div
                  className={`${styles.railButton} ${styles.railButtonWide}`}
                >
                  <ClockIcon />
                </div>
              </div>
...
export function IntuitAgentChatCoverMobile({
  ...
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      role="img"
      aria-label="The Intuit Agent Chat panel answering a question about cash flow with a long formatted article."
    >
      <foreignObject x="0" y="0" width="428" height="964">
                ...
                <div className={styles.agentMessage}>
                  ...
                  <div className={styles.markdown}>
                    <p className={styles.mdHeading}>
                      Analyze &amp; improve cash flow: Foundations for
                      sustainable operations
                    </p>
                    <p className={styles.mdSubhead}>Introduction</p>
                    <p className={styles.mdBody}>
                      Cash flow is the lifeblood of any business. Even
                      profitable companies can fail if cash inflows and outflows
                      are poorly managed. Understanding how money moves through
                      your business is critical to maintaining stability,
                      funding growth, and responding to uncertainty.
                    </p>
                    <p className={styles.mdBody}>
                      This article focuses on analyzing and improving cash flow.
                      It covers visibility into inflows and outflows,
                      forecasting techniques, and practical actions that help
                      businesses remain resilient and financially healthy. You
                      can read more on{" "}
                      <span className={styles.mdLink}>Intuit.com/help</span>.
                    </p>
                    ...
                    <div className={styles.mdGroup}>
                      ...
                      <ul className={styles.mdList}>
                        ...
                        <ul>
                          <li>
                            Revenue from sales, subscriptions, and services
                          </li>
                        ...
                        <ul>
                          <li>
                            Operating expenses such as payroll, rent, and
                            vendors
                          </li>
