              ...
              <div className={styles.info}>
                <div className={styles.infoTop}>
                  ...
                  <div className={styles.headerActions}>
                    ...
                    <span className={styles.button}>Create Resume Review</span>
                  ...
                  <div className={styles.toastCard}>
                    <div className={styles.toastBody}>
                      ...
                      <p className={styles.toastText}>
                        ...
                        <span className={styles.metaLink}>Read more here.</span>
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className={styles.considerationLeft}>
                    ...
                    <span>
                      ...
                      <p className={styles.considerationSub}>
                        Owned by{" "}
                        <span className={styles.metaLink}>Brianna Zeilger</span>
                      </p>
                    </span>
                  </div>
