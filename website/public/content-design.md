...
| MCP tool descriptions and server instructions (`website/src/app/api/mcp/route.ts`) | None | One or two lines per tool | Read by agents choosing a tool: state what it returns, never promote | This file |
